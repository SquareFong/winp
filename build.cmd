@echo off
setlocal
set PATH=%PATH%;C:\Program Files\Microsoft Visual Studio\2022\Preview\MSBuild\Current\Bin\arm64
set VCTargetsPath=C:\Program Files\Microsoft Visual Studio\2022\Preview\MSBuild\Microsoft\VC\v170\
set BUIDROOT=%cd%
...
if %errorlevel% neq 0 exit /b %errorlevel%
msbuild sendctrlc\sendctrlc.vcxproj /t:Clean /p:Configuration=Release /verbosity:minimal /nologo /p:Platform="ARM64"
if %errorlevel% neq 0 exit /b %errorlevel%
...
if %errorlevel% neq 0 exit /b %errorlevel%
msbuild ..\native_test\testapp\testapp.vcxproj /t:Clean /p:Configuration=Release /verbosity:minimal /nologo /p:Platform="ARM64"
if %errorlevel% neq 0 exit /b %errorlevel%
goto :build
...
if %errorlevel% neq 0 exit /b %errorlevel%
msbuild ..\native_test\testapp\testapp.vcxproj /verbosity:minimal /p:Configuration=Release /nologo /p:Platform="ARM64"
if %errorlevel% neq 0 exit /b %errorlevel%
...
if %errorlevel% neq 0 exit /b %errorlevel%
COPY native\ARM64\%configuration%\winp.dll src\main\resources\winp.ARM64.dll
if %errorlevel% neq 0 exit /b %errorlevel%
...
if %errorlevel% neq 0 exit /b %errorlevel%
COPY native\sendctrlc\ARM64\%configuration%\sendctrlc.exe src\main\resources\sendctrlc.ARM64.exe
if %errorlevel% neq 0 exit /b %errorlevel%
